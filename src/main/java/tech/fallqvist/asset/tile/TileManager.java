...
public class TileManager {
	...
	public TileManager(GamePanel gamePanel) {
		...
		this.mapTileNumbers = new int[gamePanel.getMaxMaps()][gamePanel.getMaxWorldColumns()][gamePanel
				.getMaxWorldRows()];
	...
	public void setup(int index, String imageName, boolean collision) {
		try {
			...
			tiles[index].setImage(
					UtilityTool.scaleImage(tiles[index].getImage(), gamePanel.getTileSize(), gamePanel.getTileSize()));
