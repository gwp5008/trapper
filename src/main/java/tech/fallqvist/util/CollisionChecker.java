...
public class CollisionChecker {
	...
	public void checkTile(Entity entity) {
		...
		case "up" -> {
			...
			tileNum1 = gamePanel.getTileManager().getMapTileNumbers()[gamePanel
					.getCurrentMap()][entityLeftCol][entityTopRow];
			tileNum2 = gamePanel.getTileManager().getMapTileNumbers()[gamePanel
					.getCurrentMap()][entityRightCol][entityTopRow];
		...
		case "down" -> {
			...
			tileNum1 = gamePanel.getTileManager().getMapTileNumbers()[gamePanel
					.getCurrentMap()][entityLeftCol][entityBottomRow];
			tileNum2 = gamePanel.getTileManager().getMapTileNumbers()[gamePanel
					.getCurrentMap()][entityRightCol][entityBottomRow];
	...
	public int checkObject(Entity entity, boolean isPlayer) {
		...
		for (int i = 0; i < objects[1].length; i++) {
			...
			if (objects[gamePanel.getCurrentMap()][i] != null) {
				...
				objects[gamePanel.getCurrentMap()][i].getCollisionArea().x = objects[gamePanel.getCurrentMap()][i]
						.getWorldX() + objects[gamePanel.getCurrentMap()][i].getCollisionArea().x;
				objects[gamePanel.getCurrentMap()][i].getCollisionArea().y = objects[gamePanel.getCurrentMap()][i]
						.getWorldY() + objects[gamePanel.getCurrentMap()][i].getCollisionArea().y;
				...
				objects[gamePanel.getCurrentMap()][i].getCollisionArea().x = objects[gamePanel.getCurrentMap()][i]
						.getCollisionDefaultX();
				objects[gamePanel.getCurrentMap()][i].getCollisionArea().y = objects[gamePanel.getCurrentMap()][i]
						.getCollisionDefaultY();
			}
		}
	...
	public int checkEntity(Entity entity, Asset[][] targets) {
		...
		for (int i = 0; i < targets[1].length; i++) {
			...
			if (targets[gamePanel.getCurrentMap()][i] != null) {
				...
				targets[gamePanel.getCurrentMap()][i].getCollisionArea().x = targets[gamePanel.getCurrentMap()][i]
						.getWorldX() + targets[gamePanel.getCurrentMap()][i].getCollisionArea().x;
				targets[gamePanel.getCurrentMap()][i].getCollisionArea().y = targets[gamePanel.getCurrentMap()][i]
						.getWorldY() + targets[gamePanel.getCurrentMap()][i].getCollisionArea().y;
	...
	public boolean checkPlayer(Entity entity) {
		...
		gamePanel.getPlayer().getCollisionArea().x = gamePanel.getPlayer().getWorldX()
				+ gamePanel.getPlayer().getCollisionArea().x;
		gamePanel.getPlayer().getCollisionArea().y = gamePanel.getPlayer().getWorldY()
				+ gamePanel.getPlayer().getCollisionArea().y;
