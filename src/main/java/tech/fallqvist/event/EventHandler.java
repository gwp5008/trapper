...
public class EventHandler {
	...
	public EventHandler(GamePanel gamePanel) {
		...
		this.eventRect = new EventRectangle[gamePanel.getMaxMaps()][gamePanel.getMaxWorldColumns()][gamePanel
				.getMaxWorldRows()];
		...
		while (map < gamePanel.getMaxMaps() && col < gamePanel.getMaxWorldColumns()
				&& row < gamePanel.getMaxWorldRows()) {
	...
	public boolean hit(int map, int col, int row, String requiredDirection) {
		...
		if (map == gamePanel.getCurrentMap()) {
			...
			if (gamePanel.getPlayer().getCollisionArea().intersects(eventRect[map][col][row])
					&& !eventRect[map][col][row].isEventDone()) {
